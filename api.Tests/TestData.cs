...
public static class TestData
{
    ...
    public static List<BaseStats> GetBaseStats()
    {
    ...
    public static List<DamageClass> GetDamageClasses()
    {
    ...
    public static List<MoveEffect> GetMoveEffects()
    {
    ...
    public static List<PkmnType> GetPkmnTypes()
    {
    ...
    public static List<PokemonAbility> GetPokemonAbilitys()
    {
    ...
    public static List<PokemonGender> GetPokemonGenders()
    {
    ...
    public static List<PokemonMove> GetPokemonMoves()
    {
    ...
    public static List<PokemonPkmnType> GetPokemonPkmnTypes()
    {
